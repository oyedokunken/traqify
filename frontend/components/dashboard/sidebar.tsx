...
import {
  ...
  Settings, Tag, Globe, Truck, Mail, X, Star, CreditCard,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "payments",   label: "Payments",   icon: CreditCard,      roles: ["OWNER","MANAGER","AUDITOR"] },
  ...
  { href: "audit-logs", label: "Audit Logs", icon: BookOpen,        roles: ["OWNER","MANAGER","AUDITOR"] },
